...
% Publicações
\include{pretextual/publicacoes}
...
\include{capitulos/2-referencias}

\include{capitulos/3-estadodaarte}

\include{capitulos/4-estudo01}

\include{capitulos/5-estudo02}
